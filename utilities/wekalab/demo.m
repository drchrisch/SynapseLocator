...
wekaOpenJavadocs('weka.classifiers.trees.RandomForest'); %cs05oct2017
...
% randomForest1 = wekaTrainModel(D,'trees.RandomForest', '-D -I 20'); Does not work!!!!
randomForest1 = wekaTrainModel(D,'trees.RandomForest', '-I 1200 -K 0 -S 1');
% randomForest2 = wekaTrainModel(D,'trees.RandomForest', {'-D' '-I' '20'}); Does not work!!!

% Classify data (input data)
[~,Y] = wekaClassify(D,randomForest1);
[predicted, classProbs, confusionMatrix]  = wekaClassify(D,randomForest1);
